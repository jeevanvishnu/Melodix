...
const Signup = () => {
  return (
    <div className='min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-black to-[#28002b]'>
        ...
        <div className="border-3 border-accent-foreground shadow-2xl w-[350px] h-[450px]" >
            <h1 className='text-[rgba(229,229,229,1)] text-center font-bold text-2xl mt-1.5' style={{fontFamily:'Montserrat, sans-serif'}}>Signup</h1>
            <form action="">
                <Input placeholder='Name' className='max-w-[260px] my-8 mx-[35px] text-white'/>
                ...
                <p className='text-[rgba(229,229,229,1)] text-[12px] mx-12'>Already hava an account 
                    <a href="" className='text-white font-bold ml-1 underline'>Log in here.</a>
                </p>
